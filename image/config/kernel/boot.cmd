...
setenv bootargs_main console=tty1 earlyprintk=serial,ttyS2,115200n8 root=/dev/mmcblk0p1 rw init=/sbin/init quiet splash loglevel=7 panic=5 consoleblank=0
