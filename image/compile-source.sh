...
make ARCH=arm CROSS_COMPILE=$TC_PREFIX LOCALVERSION="-$KERNEL_LOCAL_VERSION" $KERNEL_CONFIG_NAME
make ARCH=arm CROSS_COMPILE=$TC_PREFIX LOCALVERSION="-$KERNEL_LOCAL_VERSION" deb-pkg dtbs -j 16
